...
const hostUrl = 'https://api.docnet.id/CHCMasterH/MasterJenisOutlet'
...
class JenisOutlet extends React.Component{
    ...
    componentDidMount = () => {
        var url = hostUrl+`/masterJenisOutlet`;
    ...
    addNewData = (param)  => {
        ...
        var url = hostUrl+`/MJenisOutletBaru`;
        // axios.({
        //     method : 'post',
        //     url : url
    ...
    deleteData = (param)  => {
        ...
        var url = hostUrl+`/deleteJenisOutlet/${param}`;
        var payload ={
            jnsout_name : param
        }
        console.log(url);
