...
class MasterPointMarMove extends React.Component {
    ...
    getPointMarMove(){
        axios
        .get('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointMarMove')
        // .get('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointMarMove')
        .then((res) => {
    ...
    AddMasterPointMarMove = () => {
        axios.post('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointMarMove', {
        // axios.post('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointMarMove', {
            pmarmove_id: this.state.inputId,
            pmarmove_name: this.state.inputName,
            pmarmove_point: parseInt(this.state.inputPoint),
            pmarmove_point1: parseInt(this.state.inputPoint1),
            pmarmove_metoo: parseInt(this.state.inputMetoo),
            pmarmove_metoo1: parseInt(this.state.inputMetoo1),
    ...
    {
        axios.put('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointMarMove/' 
        // axios.put('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointMarMove/' 
        + this.state.activeItemId, {
            pmarmove_id: this.state.activeItemId,
            pmarmove_name: this.state.activeItemName,
            pmarmove_point: parseInt(this.state.activeItemPoint),
            pmarmove_point1: parseInt(this.state.activeItemPoint1),
            pmarmove_metoo: parseInt(this.state.activeItemMetoo),
            pmarmove_metoo1: parseInt(this.state.activeItemMetoo1),
    ...
    deleteMasterPointMarMove = () => {
        axios.delete('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointMarMove/' + 
        // axios.delete('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointMarMove/' + 
        this.state.pmarmove_id)
        .then((res) => { 
            console.log(res)
