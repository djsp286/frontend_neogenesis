...
class MasterPointRetur extends React.Component {
    ...
    getPointRetur(){
        axios
        .get('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointRetur')
        // .get('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointRetur')
        .then((res) => {
    ...
    AddMasterPointRetur = () => {
        axios.post('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointRetur', {
        // axios.post('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointRetur', {
            pretur_id: this.state.inputId,
            pretur_name: this.state.inputName,
            pretur_point: parseInt(this.state.inputPoint),
    ...
    {
        axios.put('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointRetur/' + this.state.activeItemId, {
        // axios.put('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointRetur/' + this.state.activeItemId, {
            pretur_id: this.state.activeItemId,
            pretur_name: this.state.activeItemName,
            pretur_point: parseInt(this.state.activeItemPoint),
    ...
    deleteMasterPointRetur = () => {
        axios.delete('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointRetur/' + this.state.pretur_id)
        // axios.delete('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointRetur/' + this.state.pretur_id)
        .then((res) => { 
            // console.log(res)
