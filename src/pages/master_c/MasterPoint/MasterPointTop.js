...
class MasterPointTop extends React.Component {
    ...
    getPointTop(){
        axios
        .get('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointTOP')
        // .get('http://10.0.111.212:8090/PointGroup/' + this.props.groupId + '/PointTOP')
        .then((res) => {
    ...
    AddMasterPointTop = () => {
        axios.post('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointTOP', {
        // axios.post('http://10.0.111.212:8090/PointGroup/' + this.props.groupId + '/PointTOP', {
            ptop_id: this.state.inputId,
            ptop_name: this.state.inputName,
            ptop_point: parseInt(this.state.inputPoint),
            ptop_userid: "CONVERT",
        }).then((res) => {
            console.log(res)
    ...
    editMasterpointTop = () => 
    {
        axios.put('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointTOP/' + this.state.activeItemId, {
        // axios.put('http://10.0.111.212:8090/PointGroup/' + this.props.groupId + '/PointTOP/' + this.state.activeItemId, {
            ptop_id: this.state.activeItemId,
            ptop_name: this.state.activeItemName, 
            ptop_point: parseInt(this.state.activeItemPoint),
            ptop_userid: "CONVERT"
        })
        .then((res) => {
            console.log(res);
    ...
    deleteMasterPointTop = () => {
        axios.delete('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointTOP/' + this.state.ptop_id)
        // axios.delete('http://10.0.111.212:8090/PointGroup/' + this.props.groupId + '/PointTOP/' + this.state.ptop_id)
        .then((res) => { 
