...
class MasterPointBeaTrans extends React.Component {
    ...
    getPointBeaTrans= () => {
      axios
        .get('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointBeaTrans')
        // .get('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointBeaTrans')
        .then((res) => {
    ...
    AddMasterPointBeaTrans = () => {
        axios.post('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointBeaTrans', {
        // axios.post('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointBeaTrans', {
            pbeatrn_id: this.state.inputId,
            pbeatrn_name: this.state.inputName,
            pbeatrn_point: parseInt(this.state.inputPoint),
    ...
    {
        axios.put('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointBeaTrans/' 
        // axios.put('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointBeaTrans/' 
        + this.state.activeItemId, {
            pbeatrn_id: this.state.activeItemId,
            pbeatrn_name: this.state.activeItemName, 
            pbeatrn_point: parseInt(this.state.activeItemPoint),
            pbeatrn_userid: "CONVERT"
        })
        .then((res) => {
            // console.log(res);
    ...
    deleteMasterPointBeaTrans = () => {
        axios.delete('https://api.docnet.id/CHCMasterProduk/PointGroup/' + this.props.groupId + '/PointBeaTrans/' 
        // axios.delete('http://10.0.111.208:8090/PointGroup/' + this.props.groupId + '/PointBeaTrans/' 
        + this.state.pbeatrn_id)
        .then((res) => { 
