...
class MasterPointGradasi extends React.Component {
    ...
    getPointGradasi= () => {
      axios
        .get('http://10.0.111.212:8090/PointGroup/1/PointGradasi')
        .then((res) => {
          this.setState({
    ...
    AddMasterPointGradasi = () => {
        axios.post('http://10.0.111.212:8090/PointGroup/1/PointGradasi', {
            grad_id: this.state.inputId,
            grad_name: this.state.inputName,
            grad_point: this.state.inputPoint,
            grad_userid: "CONVERT",
        }).then((res) => {
            this.getPointGradasi();
    ...
    {
        axios.put('http://10.0.111.212:8090/PointGroup/1/PointGradasi/' + this.state.activeItemId, {
            grad_id: this.state.activeItemId,
            grad_name: this.state.activeItemName, 
            grad_point: this.state.activeItemPoint,
            grad_userid: "CONVERT"
        })
        .then((res) => {
            console.log(res);
    ...
    deleteMasterPointGradasi = () => {
        axios.delete('http://10.0.111.212:8090/PointGroup/1/PointGradasi/' + this.state.grad_id)
        .then((res) => { 
